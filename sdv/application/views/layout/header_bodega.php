...
<nav class="navbar fixed-top navbar-expand-lg navbar-dark bg-dark" id="menu_sup">
    ...
    <div class="collapse navbar-collapse" id="navbarColor01">
      <ul class="navbar-nav mr-auto">
        ...
        <!-- <li class="nav-item" id="nav_ingreso_rec">
          <button type="button" id="btn_ingresar_rec" class="btn btn-outline-light" style="font-size:16px;font-weight: bold;"><i class="fas fa-folder-plus fa-lg"></i> Ingresar reclamo</button>
        </li> -->
        
        <li>
          <a class="btn btn-outline-light" data-toggle="collapse" href="#panel_ingreso_reclamos" role="button" aria-expanded="false" aria-controls="panel_ingreso_reclamos" id="btn_ingresar_rec">
            <i class="fas fa-folder-plus fa-lg"></i> Ingresar reclamo
          </a>          
        </li>
        <!-- <li class="nav-item" id="nav_ingreso_rec">
          <button type="button" id="btn_mantenimiento_catalogo" class="btn btn-outline-light" style="font-size:16px;font-weight: bold;"><i class="fas fa-folder-plus fa-lg"></i> Catalogo productos</button>
        </li>
 -->
        <?php if(strcmp ($this->session->userdata('tipousuario'), 'CALIDAD' ) != 0 ){ ?>
        <li>
          <a class="btn btn-outline-light" data-toggle="collapse" href="#panel_mantinimiento" role="button" aria-expanded="false" aria-controls="panel_mantinimiento" id="panel_mantinimiento_">
            <i class="fas fa-folder-plus fa-lg"></i> Catalogo productos
          </a>          
        </li>
      <?php } ?>
        <li class="d-none">
          <a class="btn btn-outline-light" data-toggle="collapse" href="#panel_info_reclamos" role="button" aria-expanded="false" aria-controls="panel_info_reclamos" id="panel_info_reclamos_">
