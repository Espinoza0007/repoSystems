    ...
    function updateStaticCache() {
        return caches.open(version + staticCacheName)
            .then(function (cache) {
                ...
                './dependencias/css/CSS_actualizacion_clte.css',
                './dependencias/css/CSS_pedido_sugerido.css',
                ...
                './dependencias/js/JS_recuperacionDatos.js',
                './dependencias/js/JS_Validacion_Exh.js',
                './dependencias/js/JS_catalogo.js',
                './dependencias/js/js_reclamoNuevo.js',
                './dependencias/js/JS_Control_Inventario.js',
                './dependencias/js/JS_pedido_sugerido.js',
                ...
                './dependencias/js/DB_recuperacionDatos.js',
                './dependencias/js/DB_reclamos.js',
                './dependencias/js/DB_pedido_sugerido.js',
                './index.php/login',
                './index.php/menu',
                './index.php/clientes',
                './index.php/encuesta-exhibidores',
                './index.php/actualizacion-clientes',
                './index.php/actualizar_datos',
                './index.php/reclamos',
                './index.php/control_inventario',
                './index.php/pedido_sugerido',
                './index.php/mercado',
                './manifest.json',
                './script.js',
                './dependencias/js/JS_mercado.js',
                './script_v2.js'
                ]);
            });
    };
